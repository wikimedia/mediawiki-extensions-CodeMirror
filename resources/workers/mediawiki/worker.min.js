...
${u}${m}`,C=I=>{let D=new ys(y,w.slice(v,S==null?void 0:S.index),n,i);return I.insertAt(D),D};for(;S;)C(a),{lastIndex:v}=k,[y]=S,S=k.exec(w);l.push(a,C(a))}}return o.slice(1)}}}),po,Ba=$({"src/nowiki/hr.ts"(){"use strict";te(),po=class extends Ct{get type(){return"hr"}}}}),fo,on,mo,Qe,Ha=$({"src/nowiki/doubleUnderscore.ts"(){"use strict";pe(),zt(),te(),fo=[Kt(),Ot("__")],Qe=class extends(mo=Ct){get type(){return"double-underscore"}constructor(t,e,s,n){var i,l;super(t,s,n);let r=t.toLowerCase(),{doubleUnderscore:[,,o,a]}=s;this.setAttribute("name",(l=e?(i=a==null?void 0:a[t])==null?void 0:i.toLowerCase():o==null?void 0:o[r])!=null?l:r)}toString(){return`__${this.innerText}__`}print(){return super.print({pre:"__",post:"__"})}},on=tt(mo),Qe=Q(on,0,"DoubleUnderscoreToken",fo,Qe),J(on,1,Qe)}}),xo={};st(xo,{parseHrAndDoubleUnderscore:()=>bo});var bo,Da=$({"parser/hrAndDoubleUnderscore.ts"(){"use strict";Ba(),Ha(),Ur(),bo=({firstChild:{data:t},type:e,name:s},n,i)=>{var l,r,o;let{doubleUnderscore:[a,c,h]}=n;return(l=n.insensitiveDoubleUnderscore)!=null||(n.insensitiveDoubleUnderscore=new Set(a)),(r=n.sensitiveDoubleUnderscore)!=null||(n.sensitiveDoubleUnderscore=new Set(c)),(o=n.regexHrAndDoubleUnderscore)!=null||(n.regexHrAndDoubleUnderscore=new RegExp(`__(${[...a,...c].join("|")})__`,"giu")),e!=="root"&&(e!=="ext-inner"||s!=="poem")&&(t=`\0${t}`),t=t.replace(/^((?:\0\d+[cno]\x7F)*)(-{4,})/gmu,(u,d,g)=>(new po(g,n,i),`${d}\0${i.length-1}r`)).replace(n.regexHrAndDoubleUnderscore,(u,d)=>{var g;let p=n.sensitiveDoubleUnderscore.has(d),x=d.toLowerCase(),b=n.insensitiveDoubleUnderscore.has(x);return p||b?(new Qe(d,p,n,i),`\0${i.length-1}${b&&((g=h==null?void 0:h[x])!=null?g:x)==="toc"?"u":"n"}`):u}),n.excludes.includes("heading")||(t=t.replace(/^((?:\0\d+[cn]\x7F)*)(={1,6})(.+)\2((?:\s|\0\d+[cn]\x7F)*)$/gmu,(u,d,g,p,x)=>{let b=`${d}\0${i.length}h`;return new xe(g.length,[p,x],n,i),b})),e==="root"||e==="ext-inner"&&s==="poem"?t:t.slice(1)}}}),vo,Ga=$({"src/nowiki/quote.ts"(){"use strict";var t,e;B(),ot(),_(),te(),vo=(e=class extends Ct{constructor(s,n,i,l){super(s,i,l),T(this,t),N(this,t,n)}get type(){return"quote"}get bold(){return this.innerText.length!==2}get italic(){return this.innerText.length!==3}get closing(){return pt(pt({},this.bold?{bold:f(this,t).bold}:void 0),this.italic?{italic:f(this,t).italic}:void 0)}text(){let{parentNode:s,innerText:n}=this;return s!=null&&s.is("image-parameter")&&s.name!=="caption"?"":n}lint(s=this.getAbsoluteIndex()){var n;let{previousSibling:i,bold:l,closing:r}=this,o=(i==null?void 0:i.type)==="text"?i.data:void 0,a=[],c=new nt(this,s),h=["lonely-apos","bold-header"],u=[void 0,"word"].map(g=>A.lintConfig.getSeverity(h[0],g)),d=A.lintConfig.getSeverity(h[1]);if(o!=null&&o.endsWith("'")){let g=u[(r.bold||r.italic)&&/[a-z\d]'$/iu.test(o)?1:0];if(g){let p=K(this,c,h[0],A.msg("lonely","'"),g),{startLine:x,startCol:b}=p,[,{length:m}]=/(?:^|[^'])('+)$/u.exec(o),w=s-m,k=Lt(pt({},p),{startIndex:w,endIndex:s,endLine:x,startCol:b-m,endCol:b});k.suggestions=[ge(w,"&apos;",m),G(k)],a.push(k)}}if(d&&l&&((n=this.closest("heading-title,ext"))==null?void 0:n.type)==="heading-title"){let g=K(this,c,h[1],"bold-in-header",d);g.suggestions=[G(g)],a.push(g)}return a}json(s,n=this.getAbsoluteIndex()){let i=super.json(void 0,n);return Object.assign(i,{bold:this.bold,italic:this.italic}),i}},t=new WeakMap,e)}}),wo={};st(wo,{parseQuotes:()=>an});var an,yo=$({"parser/quotes.ts"(){"use strict";Ga(),an=(t,e,s,n)=>{var i;let l=t.split(/('{2,})/u),{length:r}=l;if(r===1)return t;let o=0,a=0,c,h,u;for(let p=1;p<r;p+=2){let x=l[p].length;switch(x){case 2:a++;break;case 4:l[p-1]+="'",l[p]="'''";case 3:if(o++,c!==void 0)break;l[p-1].endsWith(" ")?h===void 0&&u===void 0&&(u=p):l[p-1].slice(-2,-1)===" "?c=p:h!=null||(h=p);break;default:l[p-1]+="'".repeat(x-5),l[p]="'''''",a++,o++}}if(a%2===1&&o%2===1){let p=(i=c!=null?c:h)!=null?i:u;p!==void 0&&(l[p]="''",l[p-1]+="'")}let d=!0,g=!0;for(let p=1;p<r;p+=2){let x=l[p].length,b=x!==2,m=x!==3;b&&(d=!d),m&&(g=!g),new vo(l[p],{bold:b&&d,italic:m&&g},e,s),l[p]=`\0${s.length-1}q`}return l.join("")}}}),So={};st(So,{parseExternalLinks:()=>cn});var cn,ko=$({"parser/externalLinks.ts"(){"use strict";ut(),Cl(),Hi(),cn=(t,e,s,n)=>{var i;return(i=e.regexExternalLinks)!=null||(e.regexExternalLinks=new RegExp(String.raw`\[((?:\0\d+[cn]\x7F)*(?:\0\d+f\x7F|(?:(?:${e.protocol}|//)${oe}|\0\d+m\x7F)${ae}(?=[[\]<>"\t${_t}]|\0\d)))([${_t}]*(?![${_t}]))([^\]\x01-\x08\x0A-\x1F\uFFFD]*)\]`,"giu")),t.replace(e.regexExternalLinks,(l,r,o,a)=>{let{length:c}=s,h=/&[lg]t;/u.exec(r);return h&&(o="",a=r.slice(h.index)+o+a,r=r.slice(0,h.index)),n?(new De(r,"ext-link-url",e,s),`[\0${c}f${o}${a}]`):(new we(r,o,a,e,s),`\0${c}w`)})}}}),Ao,Va=$({"src/link/category.ts"(){"use strict";ut(),os(),Ao=class extends Bt{get type(){return"category"}get sortkey(){let{childNodes:[,t]}=this;return t&&Ce(t.text())}json(t,e=this.getAbsoluteIndex()){let s=super.json(void 0,e),{sortkey:n}=this;return n&&(s.sortkey=n),s}}}}),$o={};st($o,{parseLinks:()=>un});var Co,un,Xa=$({"parser/links.ts"(){"use strict";_(),yo(),ko(),yl(),pl(),Va(),Co=/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(\||\0\d+!\x7F)([\s\S]*)$/u,un=(t,e,s,n)=>{var i;(i=e.regexLinks)!=null||(e.regexLinks=new RegExp(String.raw`^\s*(?:${e.protocol}|//)`,"iu"));let l=e.inExt?/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)([\s\S]*?[^\]]))?\]\]([\s\S]*)$/u:/^((?:(?!\0\d+!\x7F)[^\n[\]{}|])+)(?:(\||\0\d+!\x7F)([\s\S]*?[^\]])?)?\]\]([\s\S]*)$/u,r=t.split("[["),o=r.shift();for(let a=0;a<r.length;a++){let c=!1,h,u,d,g,p=r[a],x=l.exec(p);if(x)[,h,u,d,g]=x,g.startsWith("]")&&d!=null&&d.includes("[")&&(d+="]",g=g.slice(1));else{let S=Co.exec(p);S&&(c=!0,[,h,u,d]=S)}if(h===void 0||e.regexLinks.test(h)||/\0\d+[exhbru]\x7F/u.test(h)){o+=`[[${p}`;continue}let b=h.trim().startsWith(":");if(b&&c){o+=`[[${p}`;continue}let{ns:m,valid:w}=A.normalizeTitle(h,0,!1,e,{halfParsed:!0,temporary:!0,decode:!0,selfLink:!0});if(w){if(c){if(m!==6){o+=`[[${p}`;continue}let S=!1;for(a++;a<r.length;a++){let v=r[a],y=v.split("]]");if(y.length>2){S=!0,d+=`[[${y[0]}]]${y[1]}`,g=y.slice(2).join("]]");break}else if(y.length===2)d+=`[[${y[0]}]]${y[1]}`;else{d+=`[[${v}`;break}}if(d=un(d,e,s,n),!S){o+=`[[${h}${u}${d}`;continue}}}else{o+=`[[${p}`;continue}d&&(d=an(d,e,s,n));let k=Bi;b||(m===6?(d&&(d=cn(d,e,s,!0)),k=qi):m===14&&(k=Ao)),d===void 0&&u&&(d=""),o+=`\0${s.length}l${g}`,new k(h,d,e,s,u)}return o}}}),Io={};st(Io,{parseMagicLinks:()=>To});var hn,dn,gn,pn,To,Za=$({"parser/magicLinks.ts"(){"use strict";ut(),Hi(),hn=String.raw`[${_t}\t]|&nbsp;|&#0*160;|&#x0*a0;`,dn=`(?:${hn})+`,gn=`(?:${hn}|-)`,pn=String.raw`(?:RFC|PMID)${dn}\d+\b|ISBN${dn}(?:97[89]${gn}?)?(?:\d${gn}?){9}[\dx]\b`,To=(t,e,s)=>{if(!e.regexMagicLinks)try{e.regexMagicLinks=new RegExp(String.raw`(^|[^\p{L}\p{N}_])(?:(?:${e.protocol})(${oe}${ae})|${pn})`,"giu")}catch(n){e.regexMagicLinks=new RegExp(String.raw`(^|\W)(?:(?:${e.protocol})(${oe}${ae})|${pn})`,"giu")}return t.replace(e.regexMagicLinks,(n,i,l)=>{let r=i?n.slice(i.length):n;if(l){let o="",a=/&(?:lt|gt|nbsp|#x0*(?:3[ce]|a0)|#0*(?:6[02]|160));/iu.exec(r);a&&(o=r.slice(a.index),r=r.slice(0,a.index));let c=r.includes("(")?/[^,;\\.:!?][,;\\.:!?]+$/u:/[^,;\\.:!?)][,;\\.:!?)]+$/u,h=c.exec(r);if(h){let u=1;h[0][1]===";"&&/&(?:[a-z]+|#x[\da-f]+|#\d+)$/iu.test(r.slice(0,h.index))&&(u=2),o=r.slice(h.index+u)+o,r=r.slice(0,h.index+u)}return o.length>=l.length?n:(new De(r,void 0,e,s),`${i}\0${s.length-1}w${o}`)}else if(!/^(?:RFC|PMID|ISBN)/u.test(r))return n;return new De(r,"magic-link",e,s),`${i}\0${s.length-1}i`})}}}),No,Ja=$({"util/html.ts"(){"use strict";No=(t,e)=>t.startsWith(e)?e.length:[...e].findIndex((s,n)=>s!==t[n])}}),Fo,Qa=$({"src/nowiki/list.ts"(){"use strict";ao(),Fo=class extends nn{get type(){return"list"}}}}),Wo={};st(Wo,{parseList:()=>jo});var jo,Ka=$({"parser/list.ts"(){"use strict";Ja(),Qa(),co(),jo=(t,e,s,n)=>{let i=/^((?:\0\d+[cno]\x7F)*)([;:*#]+)(\s*)/u.exec(t);if(!i)return e.lastPrefix="",t;let[l,r,o,a]=i,c=o.replace(/;/gu,":"),h=No(c,e.lastPrefix),u=((h>1?o.slice(h-1):o)+a).split(/(?=;)/u),d=u[0].startsWith(";"),g=u.length-(d?0:1);if(h>1){let P=o.slice(0,h-1);if(d){let q=P.split(/(?=;)/u);u.unshift(...q),g+=P.includes(";")?q.length:0}else u[0]=P+u[0]}e.lastPrefix=c;let p=r+u.map((P,q)=>`\0${n.length+q}d`).join("")+t.slice(l.length);for(let P of u)new Fo(P,s,n);if(!g)return p;let{html:[x,,b]}=s,m=/:+|-\{|\0\d+[xq]\x7F/gu,w=m,k=w.exec(p),S=0,v=!1,y=!1,C=0,I=(P,q)=>(new rn(P,s,n),`${p.slice(0,q)}\0${n.length-1}d${p.slice(q+P.length)}`),D=P=>{P?S&&S--:S++};for(;k&&g;){let{0:P,index:q}=k;if(P==="-{"){if(!C){let{lastIndex:U}=w;w=/-\{|\}-/gu,w.lastIndex=U}C++}else if(P==="}-"){if(C--,!C){let{lastIndex:U}=w;w=m,w.lastIndex=U}}else if(P.endsWith("x")){let{name:U,closing:O,selfClosing:V}=n[Number(P.slice(1,-2))];(x.includes(U)||!V&&!b.includes(U))&&D(O)}else if(P.endsWith("q")){let{bold:U,italic:O}=n[Number(P.slice(1,-2))];U&&(D(v),v=!v),O&&(D(y),y=!y)}else if(S===0){if(P.length>=g)return I(P.slice(0,g),q);g-=P.length,w.lastIndex=q+4+String(n.length).length,p=I(P,q)}k=w.exec(p)}return p}}}),As,Lo,fn,Mo,Ke,Ya=$({"src/converterFlags.ts"(){"use strict";var t,e;B(),ot(),as(),_(),E(),Ut(),As=new Set(["A","T","R","D","-","H","N"]),Lo=[_e()],Ke=(e=class extends(Mo=W){constructor(s,n,i=[]){super(void 0,n,i,{}),T(this,t),this.safeAppend(s.map(l=>new ft(l,"converter-flag",n,i)))}get type(){return"converter-flags"}afterBuild(){N(this,t,this.childNodes.map(s=>s.text().trim())),super.afterBuild()}toString(s){return super.toString(s,";")}text(){return super.text(";")}getUnknownFlags(){return new Set(f(this,t).filter(s=>/\{{3}[^{}]+\}{3}/u.test(s)))}getVariantFlags(){let s=new Set(this.getAttribute("config").variants);return new Set(f(this,t).filter(n=>s.has(n)))}isInvalidFlag(s,n,i,l){return typeof s=="object"&&(s=s.text().trim(),n=this.getVariantFlags(),i=this.getUnknownFlags(),l=new Set(f(this,t).filter(r=>As.has(r)))),!!s&&!n.has(s)&&!i.has(s)&&(n.size>0||!l.has(s))}lint(s=this.getAbsoluteIndex(),n){let i=this.getVariantFlags(),l=this.getUnknownFlags(),r=new Set(f(this,t).filter(d=>As.has(d))),o=f(this,t).filter(d=>!d).length,a=f(this,t).length-l.size-o,c=super.lint(s,n);if(i.size===a||r.size===a)return c;let h="no-ignored",u=A.lintConfig.getSeverity(h,"conversionFlag");if(u){let d=new nt(this,s);for(let g=0;g<this.length;g++){let p=this.childNodes[g],x=p.text().trim();if(this.isInvalidFlag(x,i,l,r)){let b=R(p,d,h,"invalid-conversion-flag",u);i.size===0&&As.has(x.toUpperCase())?b.fix=Vs(b,x):b.suggestions=[G(b,g&&-1)],c.push(b)}}}return c}print(){return super.print({sep:";"})}},t=new WeakMap,e),fn=tt(Mo),Ke=Q(fn,0,"ConverterFlagsToken",Lo,Ke),J(fn,1,Ke)}}),$s,tc=$({"src/converterRule.ts"(){"use strict";_(),E(),Ut(),$s=class extends W{get type(){return"converter-rule"}get variant(){var t,e;return(e=(t=this.childNodes[this.length-2])==null?void 0:t.text().trim().toLowerCase())!=null?e:""}constructor(t,e=!0,s=A.getConfig(),n=[]){super(void 0,s,n);let i=t.indexOf(":"),l=t.slice(0,i).indexOf("=>"),r=l===-1?t.slice(0,i):t.slice(l+2,i);e&&s.variants.includes(r.trim().toLowerCase())?(super.insertAt(new ft(r,"converter-rule-variant",s,n)),super.insertAt(new ft(t.slice(i+1),"converter-rule-to",s,n)),l!==-1&&super.insertAt(new ft(t.slice(0,l),"converter-rule-from",s,n),0)):super.insertAt(new ft(t,"converter-rule-to",s,n))}toString(t){let{childNodes:e,firstChild:s,lastChild:n}=this;return e.length===3?`${s.toString(t)}=>${e[1].toString(t)}:${n.toString(t)}`:super.toString(t,":")}text(){let{childNodes:t,firstChild:e,lastChild:s}=this;return t.length===3?`${e.text()}=>${t[1].text()}:${s.text()}`:super.text(":")}getGaps(t){return t===0&&this.length===3?2:1}print(){let{childNodes:t}=this;if(t.length===3){let[e,s,n]=t;return`<span class="wpb-converter-rule">${e.print()}=>${s.print()}:${n.print()}</span>`}return super.print({sep:":"})}json(t,e=this.getAbsoluteIndex()){let s=super.json(void 0,e);return s.variant=this.variant,s}}}}),Oo,mn,Po,Ye,ec=$({"src/converter.ts"(){"use strict";ut(),zt(),Mt(),E(),Ya(),tc(),Oo=[Ft,Ot("-{")],Ye=class extends(Po=W){get type(){return"converter"}constructor(t,e,s,n=[]){super(void 0,s,n),this.insertAt(new Ke(t,s,n));let[i]=e,l=i.includes(":"),r=new $s(i,l,s,n);l&&r.length===1||!l&&e.length===2&&!yt(e[1]).trim()?this.insertAt(new $s(e.join(";"),!1,s,n)):this.append(r,...e.slice(1).map(o=>new $s(o,!0,s,n)))}toString(t){let{childNodes:[e,...s]}=this;return`-{${e.toString(t)}${e.length>0?"|":""}${s.map(n=>n.toString(t)).join(";")}}-`}text(){let{childNodes:[t,...e]}=this;return`-{${t.text()}|${Vt(e,";")}}-`}getGaps(t){return t||this.firstChild.length>0?1:0}print(){let{childNodes:[t,...e]}=this;return`<span class="wpb-converter">-{${t.print()}${t.length>0?"|":""}${he(e,{sep:";"})}}-</span>`}},mn=tt(Po),Ye=Q(mn,0,"ConverterToken",Oo,Ye),J(mn,1,Ye)}}),Ro={};st(Ro,{parseConverter:()=>Eo});var Eo,sc=$({"parser/converter.ts"(){"use strict";ec(),Eo=(t,e,s)=>{var n;(n=e.regexConverter)!=null||(e.regexConverter=new RegExp(String.raw`;(?=(?:[^;]*?=>)?\s*(?:${e.variants.join("|")})\s*:|(?:\s|\0\d+[cn]\x7F)*$)`,"iu"));let i=/-\{/gu,l=/-\{|\}-/gu,r=[],o=i,a=o.exec(t);for(;a;){let{0:c,index:h}=a;if(c==="}-"){let u=r.pop(),{length:d}=s,g=t.slice(u.index+2,h),p=g.indexOf("|"),[x,b]=p===-1?[[],g]:[g.slice(0,p).split(";"),g.slice(p+1)],m=b.replace(/(&[#a-z\d]+);/giu,"$1"),w=m.split(e.regexConverter).map(k=>k.replace(/\x01/gu,";"));new Ye(x,w,e,s),t=`${t.slice(0,u.index)}\0${d}v${t.slice(h+2)}`,r.length===0&&(o=i),o.lastIndex=u.index+3+String(d).length}else r.push(a),o=l,o.lastIndex=h+2;a=o.exec(t)}return t}}}),Cs={};st(Cs,{Token:()=>W});var _o,W,E=$({"src/index.ts"(){"use strict";var t,e,s,n,i,l,r,o,a,c,h,u,d,g,p,x,b,m,w,k,S;ut(),Xt(),B(),Wt(),_(),ma(),xa(),_o=["category","html-attr#id,ext-attr#id,table-attr#id"],W=(S=class extends Pe{constructor(v,y=A.getConfig(),C=[],I){super(),T(this,o),T(this,t,"plain"),T(this,e,0),T(this,s),T(this,n),T(this,i),T(this,l,!1),T(this,r),typeof v=="string"&&this.insertAt(v),N(this,s,y),N(this,n,C),C.push(this)}get type(){return f(this,t)}set type(v){N(this,t,v)}parseOnce(v=f(this,e),y=!1,C){if(v<f(this,e)||this.length===0||!this.isPlain())return this;if(f(this,e)>=St)return this;switch(v){case 0:if(this.type==="root"){f(this,n).pop();let I=M(this,o,a).call(this);y&&(y=!I)}N(this,i,y),M(this,o,c).call(this,y);break;case 1:M(this,o,h).call(this);break;case 2:M(this,o,u).call(this);break;case 3:M(this,o,d).call(this);break;case 4:M(this,o,g).call(this);break;case 5:M(this,o,p).call(this,C);break;case 6:M(this,o,x).call(this,C);break;case 7:M(this,o,b).call(this);break;case 8:M(this,o,m).call(this);break;case 9:M(this,o,w).call(this);break;case 10:M(this,o,k).call(this)}if(this.type==="root")for(let I of f(this,n))I==null||I.parseOnce(v,y,C);return na(this,e)._++,this}buildFromStr(v,y){let C=v.split(/[\0\x7F]/u).map((I,D)=>{if(D%2===0)return new si(I);if(isNaN(I.slice(-1)))return f(this,n)[Number(I.slice(0,-1))];throw new Error(`Failed to build! Unrecognized token: ${I}`)});return y===0?C.map(String).join(""):y===1?Vt(C):C}build(){N(this,e,St);let{length:v,firstChild:y}=this,C=y==null?void 0:y.toString();if(v===1&&y.type==="text"&&C.includes("\0")&&(xn(this,0,1,this.buildFromStr(C)),this.normalize(),this.type==="root"))for(let I of f(this,n))I==null||I.build()}afterBuild(){if(this.type==="root")for(let v of f(this,n))v==null||v.afterBuild();N(this,l,!0)}parse(v=St,y,C){for(v=Math.min(v,St);f(this,e)<v;)this.parseOnce(f(this,e),y,C);return v&&(this.build(),this.afterBuild()),this}isPlain(){return this.constructor===S}getAttribute(v){var y;switch(v){case"config":return f(this,s);case"include":return(y=f(this,i))!=null?y:!!f(this.getRootNode(),i);case"accum":return f(this,n);case"built":return f(this,l);case"stage":return f(this,e);case"invalid":return this.type==="table-inter"&&Ne(this)===2;default:return super.getAttribute(v)}}setAttribute(v,y){switch(v){case"stage":f(this,e)===0&&this.type==="root"&&f(this,n).shift(),N(this,e,y);break;default:super.setAttribute(v,y)}}insertAt(v,y=this.length){let C=typeof v=="string"?new si(v):v;super.insertAt(C,y);let{type:I}=C;return I==="root"&&(C.type="plain"),C}normalizeTitle(v,y=0,C){return A.normalizeTitle(v,y,f(this,i),f(this,s),C)}inTableAttrs(){var v,y;return((v=this.closest("table-attrs,ext"))==null?void 0:v.type)==="table-attrs"&&((y=this.closest("table-attrs,arg,magic-word,template"))!=null&&y.is("table-attrs")?2:1)}inHtmlAttrs(){var v;return(v=this.closest("html-attrs,ext"))!=null&&v.is("html-attrs")?2:this.inTableAttrs()}lint(v=this.getAbsoluteIndex(),y){var C;let I=super.lint(v,y);if(this.type==="root"){let D=new Map,P="no-duplicate",q=["category","id"].map(j=>A.lintConfig.getSeverity(P,j)),U=_o.filter((j,F)=>q[F]).join();if(U){for(let j of this.querySelectorAll(U)){let F;if(j.is("category"))F=j.name;else{let H=j.getValue();H&&H!==!0&&(F=`#${H}`)}if(F){let H=D.get(F);H?H.add(j):D.set(F,new Set([j]))}}for(let[j,F]of D)if(F.size>1&&!j.startsWith("#mw-customcollapsible-")){let H=!j.startsWith("#"),Y=`duplicate-${H?"category":"id"}`,dt=q[H?0:1];I.push(...[...F].map(rt=>{let at=K(rt,{start:rt.getAbsoluteIndex()},P,Y,dt);return H&&(at.suggestions=[G(at)]),at}))}}let O=/<!--\s*lint-(disable(?:(?:-next)?-line)?|enable)(\s[\sa-z,-]*)?-->/gu,V=this.toString(),lt=[],et=O.exec(V);for(;et;){let{1:j,index:F}=et,H=(C=et[2])==null?void 0:C.trim();lt.push({line:this.posFromIndex(F).top+(j==="disable-line"?0:1),from:j==="disable"?O.lastIndex:void 0,to:j==="enable"?O.lastIndex:void 0,rules:H?new Set(H.split(",").map(Y=>Y.trim())):void 0}),et=O.exec(V)}if(I=I.filter(({rule:j,startLine:F,startIndex:H})=>{let Y={pos:0};for(let{line:dt,from:rt,to:at,rules:Nt}of lt){if(dt>F+1)break;if(!(Nt&&!Nt.has(j))){if(dt===F&&rt===void 0&&at===void 0)return!1;rt<=H&&rt>Y.pos?(Y.pos=rt,Y.type="from"):at<=H&&at>Y.pos&&(Y.pos=at,Y.type="to")}}return Y.type!=="from"}),I.some(({fix:j})=>j)){let j=I.map(({fix:Y})=>Y).filter(Boolean).sort(({range:[Y,dt]},{range:[rt,at]})=>dt===at?rt-Y:at-dt),F=1/0,H=V;for(let{range:[Y,dt],text:rt}of j)dt<=F&&(H=H.slice(0,Y)+rt+H.slice(dt),F=Y);Object.assign(I,{output:H})}}return I}toString(v,y){return v?super.toString(!0,y):Jt(f(this,r),()=>super.toString(!1,y),C=>{let I=this.getRootNode();I.type==="root"&&f(I,l)&&N(this,r,C)})}},t=new WeakMap,e=new WeakMap,s=new WeakMap,n=new WeakMap,i=new WeakMap,l=new WeakMap,r=new WeakMap,o=new WeakSet,a=function(){let{parseRedirect:v}=(wa(),Z(mr)),y=this.firstChild.toString(),C=v(y,f(this,s),f(this,n));return C&&this.setText(C),!!C},c=function(v){let{parseCommentAndExt:y}=(vs(),Z(Ul));this.setText(y(this.firstChild.toString(),f(this,s),f(this,n),v))},h=function(){let{parseBraces:v}=(Li(),Z(Qr)),y=this.type==="root"?this.firstChild.toString():`\0${this.firstChild.toString()}`,C=v(y,f(this,s),f(this,n));this.setText(this.type==="root"?C:C.slice(1))},u=function(){if(f(this,s).excludes.includes("html"))return;let{parseHtml:v}=(_a(),Z(Jl));this.setText(v(this.firstChild.toString(),f(this,s),f(this,n)))},d=function(){if(f(this,s).excludes.includes("table"))return;let{parseTable:v}=(Ua(),Z(uo));this.setText(v(this,f(this,s),f(this,n)))},g=function(){if(f(this,s).excludes.includes("hr"))return;let{parseHrAndDoubleUnderscore:v}=(Da(),Z(xo));this.setText(v(this,f(this,s),f(this,n)))},p=function(v){let{parseLinks:y}=(Xa(),Z($o));this.setText(y(this.firstChild.toString(),f(this,s),f(this,n),v))},x=function(v){if(f(this,s).excludes.includes("quote"))return;let{parseQuotes:y}=(yo(),Z(wo)),C=this.firstChild.toString().split(`
`);for(let I=0;I<C.length;I++)C[I]=y(C[I],f(this,s),f(this,n),v);this.setText(C.join(`
`))},b=function(){if(f(this,s).excludes.includes("extLink"))return;let{parseExternalLinks:v}=(ko(),Z(So));this.setText(v(this.firstChild.toString(),f(this,s),f(this,n)))},m=function(){if(f(this,s).excludes.includes("magicLink"))return;let{parseMagicLinks:v}=(Za(),Z(Io));this.setText(v(this.firstChild.toString(),f(this,s),f(this,n)))},w=function(){if(f(this,s).excludes.includes("list"))return;let{parseList:v}=(Ka(),Z(Wo)),{firstChild:y,type:C,name:I}=this,D=y.toString().split(`
`),P={lastPrefix:""},q=C==="root"||C==="ext-inner"&&I==="poem"?0:1;for(;q<D.length;q++)D[q]=v(D[q],P,f(this,s),f(this,n));this.setText(D.join(`
`))},k=function(){if(f(this,s).variants.length>0){let{parseConverter:v}=(sc(),Z(Ro));this.setText(v(this.firstChild.toString(),f(this,s),f(this,n)))}},S)}}),kt,Is,xn,Wt=$({"util/debug.ts"(){"use strict";kt={running:!1,run(t){let{running:e}=this;this.running=!0;try{let{Token:s}=(E(),Z(Cs)),n=t();return n instanceof s&&!n.getAttribute("built")&&n.afterBuild(),this.running=e,n}catch(s){throw this.running=e,s}},rev:0},Is=t=>e=>e.type===t,xn=(t,e,s,n=[])=>{var i,l;let r=t.getChildNodes(),o;r.length===s?(o=r,r=n):o=r.splice(e,s,...n);for(let a=0;a<n.length;a++){let c=n[a];c.setAttribute("parentNode",t),c.setAttribute("nextSibling",r[e+a+1]),c.setAttribute("previousSibling",r[e+a-1])}return(i=r[e-1])==null||i.setAttribute("nextSibling",r[e]),(l=r[e+n.length])==null||l.setAttribute("previousSibling",r[e+n.length-1]),r===n&&t.setAttribute("childNodes",r),o}}}),qo,Ts,bn,vn,zo,wn,Uo,yn,ic=$({"lib/lintConfig.ts"(){"use strict";On(),qo=new Set([0,1,2]),Ts=new Map([[0,!1],[1,"warning"],[2,"error"]]),bn={"bold-header":[1,{}],"format-leakage":[1,{}],"fostered-content":[1,{}],h1:[1,{}],"illegal-attr":[2,{}],"insecure-style":2,"invalid-gallery":[2,{parameter:1}],"invalid-imagemap":[2,{}],"invalid-invoke":[2,{}],"invalid-isbn":2,"lonely-apos":[1,{}],"lonely-bracket":[1,{extLink:2}],"lonely-http":[1,{}],"nested-link":[2,{}],"no-arg":1,"no-duplicate":[2,{category:1,id:1,unknownImageParameter:1}],"no-ignored":[2,{fragment:1,galleryComment:1,galleryNoImage:1,include:1,nonWordAttributes:1,redirect:1}],"obsolete-attr":1,"obsolete-tag":1,"parsing-order":[2,{templateInTable:1}],"pipe-like":[1,{double:2}],"table-layout":1,"tag-like":[2,{disallowed:1,invalid:1}],"unbalanced-header":2,"unclosed-comment":[1,{}],"unclosed-quote":1,"unclosed-table":2,unescaped:2,"unknown-page":1,"unmatched-tag":[1,{}],"unterminated-url":[1,{}],"url-encoding":[1,{}],"var-anchor":[1,{}],"void-ext":[2,{}]},Object.freeze(bn),vn=t=>typeof t=="number"&&qo.has(t),zo=t=>vn(t)||Array.isArray(t)&&t.length===2&&vn(t[0])&&t[1]&&typeof t[1]=="object",wn=(t,e,s)=>{if(_s.includes(e)){if(zo(s))return t[e]=s,!0}else throw new RangeError(`Unknown lint rule: ${e}`);throw new RangeError(`Invalid lint config for ${e}: ${JSON.stringify(s)}`)},Uo=class{constructor(t){if(Object.assign(this,JSON.parse(JSON.stringify(bn))),!!t)for(let[e,s]of Object.entries(t))wn(this,e,s)}getSeverity(t,e){var s;let n=this[t];return typeof n=="number"?Ts.get(n):e&&(s=Ts.get(n[1][e]))!=null?s:Ts.get(n[0])}},yn=t=>new Proxy(new Uo(t),{set:wn})}}),Bo={};st(Bo,{Title:()=>Ho});var Ho,nc=$({"lib/title.ts"(){"use strict";var t,e,s,n,i,l;Zt(),ut(),Ho=(l=class{constructor(r,o,a,{temporary:c,decode:h,selfLink:u}={}){T(this,t),T(this,e),T(this,s),T(this,n),T(this,i),Rt(this,"valid"),Rt(this,"encoded",!1);let d=r.trim().startsWith("../");if(h&&r.includes("%"))try{let p=/%(?!21|3[ce]|5[bd]|7[b-d])[\da-f]{2}/iu.test(r);r=Te(r),this.encoded=p}catch(p){}if(r=Ce(r).replace(/[_ ]+/gu," ").trim(),d)N(this,n,0);else{let p=o;r.startsWith(":")&&(p=0,r=r.slice(1).trim());let x=r.split(":");if(x.length>1){let b=ce(x[0]),m=Object.prototype.hasOwnProperty.call(a.nsid,b)&&a.nsid[b];m&&(p=m,r=x.slice(1).join(":").trim())}N(this,n,p)}let g=r.indexOf("#");if(g!==-1){let p=r.slice(g).trim().slice(1);if(p.includes("%"))try{p=Te(p)}catch(x){}N(this,i,p.replace(/ /gu,"_")),r=r.slice(0,g).trim()}this.valid=!!(r||u&&this.ns===0&&f(this,i)!==void 0)&&Ce(r)===r&&!/^:|\0\d+[eh!+-]\x7F|[<>[\]{}|\n]|%[\da-f]{2}|(?:^|\/)\.{1,2}(?:$|\/)/iu.test(d?/^(?:\.\.\/)+(.*)/u.exec(r)[1]:r),this.main=r,N(this,e,a.namespaces),N(this,s,a.articlePath||"/wiki/$1"),f(this,s).includes("$1")||N(this,s,f(this,s)+`${f(this,s).endsWith("/")?"":"/"}$1`),c||Object.defineProperties(this,{encoded:{enumerable:!1,writable:!1}})}get ns(){return f(this,n)}get fragment(){return f(this,i)}get main(){return f(this,t)}set main(r){r=r.replace(/_/gu," ").trim(),N(this,t,r&&r[0].toUpperCase()+r.slice(1))}get prefix(){let r=f(this,e)[this.ns];return r+(r&&":")}get title(){return this.getRedirection()[1]}get extension(){let{main:r}=this,o=r.lastIndexOf(".");return o===-1?void 0:r.slice(o+1).toLowerCase()}getRedirection(){return[!1,(this.prefix+this.main).replace(/ /gu,"_")]}setFragment(r){N(this,i,r)}getUrl(r){throw new Error("Title.getUrl method is only available in the LSP version!")}},t=new WeakMap,e=new WeakMap,s=new WeakMap,n=new WeakMap,i=new WeakMap,l)}}),Do={};st(Do,{default:()=>A}),L.exports=Z(Do);var Ns,Sn,Go,Dt,kn,Vo,A,_=$({"index.ts"(){On(),Wt(),Xt(),ut(),ic(),Ns=!0,Sn=yn(),Dt={rules:_s,config:zs,get i18n(){return pt(pt({},Un),Go)},set i18n(t){Go=t},get lintConfig(){return Sn},set lintConfig(t){Sn=yn(t)},get viewOnly(){return Ns},set viewOnly(t){Ns&&!t&&kt.rev++,Ns=t},getConfig(t){let e=t!=null?t:this.config,{doubleUnderscore:s,ext:n,parserFunction:i,variable:l}=e;for(let r=0;r<2;r++)s.length>r+2&&s[r].length===0&&(s[r]=Object.keys(s[r+2]));return n.includes("translate")&&!l.includes("translationlanguage")&&(l.push("translationlanguage"),Array.isArray(i[1])?i[1].push("TRANSLATIONLANGUAGE"):i[1].TRANSLATIONLANGUAGE="translationlanguage"),Lt(pt(pt({},zs),e),{excludes:[]})},msg(t,e=""){var s;return t&&((s=this.i18n[t])!=null?s:t).replace("$1",this.msg(e))},normalizeTitle(t,e=0,s,n=Dt.getConfig(),i){let{Title:l}=(nc(),Z(Bo)),r;if(i!=null&&i.halfParsed)r=new l(t,e,n,i);else{let{Token:o}=(E(),Z(Cs));r=kt.run(()=>{let a=new o(t,n);a.type="root",a.parseOnce(0,s).parseOnce();let c=new l(a.toString(),e,n,i);a.build();for(let h of["main","fragment"]){let u=c[h];if(u!=null&&u.includes("\0")){let d=a.buildFromStr(u,1);h==="main"?c.main=d:c.setFragment(d)}}return c})}return r},parse(t,e,s=St,n=Dt.getConfig()){t=Pn(t);let i;typeof s!="number"&&(i=Array.isArray(s)?s:[s],s=Math.max(...i.map(r=>Mn[r]||St)));let{Token:l}=(E(),Z(Cs));return kt.run(()=>{let r=new l(t,n);return r.type="root",r.parse(s,e)})},async partialParse(t,e,s,n=Dt.getConfig()){},createLanguageService(t={}){throw new Error("Parser.createLanguageService method is only available in the LSP version!")}},kn={},Vo=new Set(["lintConfig","normalizeTitle","parse","createLanguageService"]);for(let t in Dt)Vo.has(t)||(kn[t]={enumerable:!1});Object.defineProperties(Dt,kn),Object.assign(typeof globalThis=="object"?globalThis:self,{Parser:Dt}),A=Dt}});_()});ra()})()});var rc=ea();sa();Parser.lintConfig={"bold-header":0,"format-leakage":0,"fostered-content":0,h1:0,"insecure-style":0,"lonely-apos":0,"lonely-bracket":[0,{extLink:2}],"lonely-http":0,"no-arg":0,"obsolete-attr":0,"obsolete-tag":0,"pipe-like":[0,{double:2}],"table-layout":0,"unclosed-comment":0,"unclosed-quote":0,"unclosed-table":0,"unknown-page":0,"unmatched-tag":0,"unterminated-url":0,"url-encoding":0,"var-anchor":0};var Ws={},lc=mt=>{Parser.config=mt},oc=()=>Parser.getConfig(),ac=mt=>{let xt={};for(let jt in mt)jt.startsWith("codemirror-wikilint-")&&(xt[jt.slice(20)]=mt[jt]);Parser.i18n=xt},cc=()=>Parser.i18n,uc=mt=>{if(Ws.wikitext===mt)return Ws.errors;let xt=Parser.parse(mt).lint().filter(({severity:jt})=>jt==="error");return Ws.wikitext=mt,Ws.errors=xt,xt};rc(lc,oc,uc,ac,cc);})();
